"""Entrenamiento y guardado de los modelos del caso Diabetes.
...
def build_models(preprocessor) -> dict:
    ...
    return {
        ...
        "polynomial_degree_2": Pipeline(
            steps=[
                ("pre", preprocessor),
                # Expande las variables a términos de grado 2 (66 features).
        ...
        "polynomial_degree_3": Pipeline(
            steps=[
                ("pre", preprocessor),
                # Grado 3 (286 features): alto riesgo de sobreajuste con 442 filas.
...
def main() -> None:
    ...
    for name, pipeline in models.items():
        ...
        plot_actual_vs_predicted(
            y_test, y_pred,
            f"Progresión real vs predicha — {name}",
